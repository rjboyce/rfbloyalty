...
import com.rjboyce.config.Constants;
...
public class UserService {
    ...
    private User syncUserWithIdP(Map<String, Object> details, User user) {
        ...
        if (existingUser.isPresent()) {
            ...
            System.out.println("\u001B[96m" + "USER HAS AUTHORITIES: " + user.getAuthorities().toString() + "\u001B[0m");
            //change here - save to BOTH User and ApplicationUser
            volunteerRepository.save(volunteerService.convertUser(user));
