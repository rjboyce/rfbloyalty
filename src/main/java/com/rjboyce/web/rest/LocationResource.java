...
public class LocationResource {
    ...
    public LocationResource(LocationService locationService, LocationRepository locationRepository, LocationMapper locationMapper) {
    ...
    @GetMapping(value = "/locations", params = { "match" })
    public ResponseEntity<List<LocationDTO>> getAllMatchedlocations(@RequestParam(value = "match") String match) {
        log.debug("REST request to get a page of locations");
        Optional<List<LocationDTO>> locationDTO = locationRepository
            .findByLocationNameContainingIgnoreCase(match)
